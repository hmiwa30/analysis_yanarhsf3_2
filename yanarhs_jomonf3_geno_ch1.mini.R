...
#write.table(df1,"analysis_yanarhsf3_2/yana_j_f3_analysis_denisova.ind",quote=F,col.names=F,row.names=F)
...
out01.geno <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini01.geno","w")
out01.snp <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini01.snp","w")
out02.geno <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini02.geno","w")
out02.snp <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini02.snp","w")
out03.geno <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini03.geno","w")
out03.snp <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini03.snp","w")
out04.geno <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini04.geno","w")
out04.snp <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini04.snp","w")
out05.geno <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini05.geno","w")
out05.snp <- file("analysis_yanarhsf3_2/results/yana_j_f3_analysis_ch1.mini05.snp","w")
