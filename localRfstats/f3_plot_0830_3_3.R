...
for(i in c(3,4)){
  ...
  "yana_j_f3_analysis"
  "where fstats txt is"
  (ft_fix="G:\\hmiwa\\m_20211215\\07_yana_saami3\\git\\analysis_yanarhsf3_2\\localRfstats\\results\\yana_j_f3_analysis_0819")
  "where picture will be saved"
  (pn_fix="G:\\hmiwa\\m_20211215\\07_yana_saami3\\git\\analysis_yanarhsf3_2\\localRfstats\\results\\picture\\yana_j_f3_analysis_0819")
  "where .ind file is"
  ...
  "yana_j_f3_analysis"
  "where fstats txt is"
  (ft_fix="G:\\hmiwa\\m_20211215\\07_yana_saami3\\git\\analysis_yanarhsf3_2\\localRfstats\\results\\yana_j_f3_analysis_0826")
  "where picture will be saved"
  (pn_fix="G:\\hmiwa\\m_20211215\\07_yana_saami3\\git\\analysis_yanarhsf3_2\\localRfstats\\results\\picture\\yana_j_f3_analysis_0826")
  "where .ind file is"
  (in_fix="G:\\hmiwa\\m_20211215\\07_yana_saami3\\git\\analysis_yanarhsf3\\localRfstats\\sources\\yana_j_f3_analysis")
  ...
  ( outputname <- sprintf("%s_%s_part%s.f3_FIN.png",pn_fix,"mini.all",i) )
